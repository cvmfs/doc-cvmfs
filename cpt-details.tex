...
IPv6 addresses have precedence if available, unless the \texttt{CVMFS\_IPV4\_ONLY} environment variable is set.
In this case, \cvmfs\ does not try to resolve IPv6 records.
