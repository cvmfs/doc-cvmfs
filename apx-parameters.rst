...
.. raw:: html
    ...
    <form action="" onSubmit="return false;">
        <input class="description" type="text" id="filterclientparams" onkeypress="filtertable('filterclientparams', 'tblclientparams')" placeholder="Search client parameters..." title="Type in anything" />
        <button type="button" class="btn" onclick="document.getElementById('filterclientparams').value = null; filtertable('filterclientparams', 'tblclientparams');"><span>&times;</span></button>
    </form>
    </div>
    </p>
