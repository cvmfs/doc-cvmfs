...
\subsection{Managing Named Snapshots}
\label{sct:namedsnapshots}

At the point of publishing, the resulting snapshot can be named using the -a option like
\begin{verbatim}
...
The tag name must not contain spaces or special characters.
Named snapshots can be listed by
\begin{verbatim}
cvmfs_server list-tags
\end{verbatim}

Named snapshots can be removed (unpublish) with the -r option like
\begin{verbatim}
cvmfs_server transaction
