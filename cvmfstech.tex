...
\renewcommand\today{December 2012}
...
\abstract{
	...
	It was developed to assist High Energy Physics (HEP) collaborations to deploy their software on the worldwide-distributed computing infrastructure used to run their data processing applications.
