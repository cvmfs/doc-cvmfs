...
Also, \autofs\ for \cvmfs\ needs to be turned off and repositories need to be mounted manually\footnote{The \texttt{cvmfs\_config chksetup} utility will print a warning when \autofs\ is disabled.  The warning can be ignored in case of the NFS mode.}.
